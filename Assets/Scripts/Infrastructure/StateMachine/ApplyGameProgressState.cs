...
namespace Infrastructure.StateMachine
{
    public class ApplyGameProgressState : IState
    {
        ...
        public ApplyGameProgressState(IStateSwitcher gameStateMachine, ScreenLoading screenLoading, IInventoryChanger inventory, IWallet wallet, IPersistenceProgressService progressService, IFieldService fieldService)
        {
